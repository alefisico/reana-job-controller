...
class JobRequest(Schema):
    ...
    slurm_cpus = fields.Int(required=False)
    slurm_mem = fields.Int(required=False)
    slurm_nodes = fields.Int(required=False)
    slurm_ntasks = fields.Int(required=False)
    slurm_gres = fields.Str(required=False)
